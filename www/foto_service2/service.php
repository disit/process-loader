...
<script type='text/javascript'>
	...
	function myCardsWriter(rowIndex, record, columns, cellWriter)
	{
		...
		if(file_type=="ETL" || file_type=="R" || file_type=="Java"){
			//var modal='<div class="modal fade" id="info-modal_proc'+record.id+'" role="dialog"><div class="modal-dialog"><div class="modal-content"><div class="modal-header"><button type="button" class="close" data-dismiss="modal">&times;</button><h4 class="modal-title">Details of Resource: '+record.file_name+'</h4></div><div class="modal-body"><center><img src="'+record.image+'" height="50%" width="50%" border="0" ></a><div class="row"><h4>Resource name: <span>'+record.file_name+'</span></h4><h4>Rating:</h4><div class="ratin"><input name="input"  class="rating-loading" step="0.1 "value="'+record.average_stars+'">( mean '+record.average_stars+' on '+record.votes+' votes)</div></center><ul class="list-group"><li class="list-group-item"><b>Description: </b>'+description+'</li><li class="list-group-item" id="itemUsername" hidden><b>Username: </b>'+record.username+'</li><li class="list-group-item"><b>Resource Type: </b>'+record.resource_type+'</li><li class="list-group-item"><b>Nature: </b>'+record.nature+'</li><li class="list-group-item"><b>Sub Nature: </b>'+record.sub_nature+'</li><li class="list-group-item"><b>Protocol: </b>'+record.protocol+'</li><li class="list-group-item"><b>Real-time: </b>'+record.realtime+'</li><li class="list-group-item"><b>Periodic: </b>'+record.periodic+'</li><li class="list-group-item"><b>Date_of_publication: </b>'+data_pubblicazione+'</li><li class="list-group-item"><b>License: </b>'+record.license+'</li>'+status_pub+'</ul><div class="space-ten"></div></div><div class="modal-footer"><button  type="button" class="btn btn-default" data-dismiss="modal">Close</button></div></div></div></div></div>';
			var modal='<div class="modal fade" id="info-modal_proc'+record.id+'" role="dialog"><div class="modal-dialog"><div class="modal-content"><div class="modal-header" style="padding-bottom: 10px"><button type="button" class="close" data-dismiss="modal">&times;</button><h4 class="modal-title">Details of Resource: '+record.file_name+'</h4></div><div class="modal-body" style="padding:0px;"><center><div class="dashboardsListCardImgDiv" style="background-image:url('+record.image+'); overflow: auto; margin-top: 10px; margin-bottom: 5px;"></div></a><div class="row"><h4>Resource name: <span>'+record.file_name+'</span></h4><h4>Rating:</h4><div class="ratin"><input name="input"  class="rating-loading" step="0.1 "value="'+record.average_stars+'">( mean '+record.average_stars+' on '+record.votes+' votes)</div></center><ul class="list-group" style="margin-bottom: 0px;"><li class="list-group-item"><b>Description: </b>'+description+'</li><li class="list-group-item" id="itemUsername" hidden><b>Username: </b>'+record.username+'</li><li class="list-group-item"><b>Resource Type: </b>'+record.resource_type+'</li><li class="list-group-item"><b>Nature: </b>'+record.nature+'</li><li class="list-group-item"><b>Sub Nature: </b>'+record.sub_nature+'</li><li class="list-group-item"><b>Protocol: </b>'+record.protocol+'</li><li class="list-group-item"><b>Real-time: </b>'+record.realtime+'</li><li class="list-group-item"><b>Periodic: </b>'+record.periodic+'</li><li class="list-group-item"><b>Date_of_publication: </b>'+data_pubblicazione+'</li><li class="list-group-item"><b>License: </b>'+record.license+'</li>'+status_pub+'</ul><div class="space-ten"></div></div><div class="modal-footer"><button  type="button" class="btn btn-default" data-dismiss="modal">Close</button></div></div></div></div></div>';
		...
		if(file_type=="IoTBlocks" || file_type=="IoTApp"){
			//var modal='<div class="modal fade" id="info-modal_proc'+record.id+'" role="dialog"><div class="modal-dialog"><div class="modal-content"><div class="modal-header"><button type="button" class="close" data-dismiss="modal">&times;</button><h4 class="modal-title">Details of Resource: '+record.file_name+'</h4></div><div class="modal-body"><center><img src="'+record.image+'" height="50%" width="50%" border="0" ></a><div class="row"><h4>Resource name: <span>'+record.file_name+'</span></h4><h4>Rating:</h4><div class="ratin"><input name="input"  class="rating-loading" step="0.1 "value="'+record.average_stars+'">( mean '+record.average_stars+' on '+record.votes+' votes)</div></center><ul class="list-group"><li class="list-group-item"><b>Description: </b>'+description+'</li><li class="list-group-item" id="itemUsername" hidden><b>Username: </b>'+record.username+'</li><li class="list-group-item"><b>Resource Type: </b>'+record.resource_type+'</li><li class="list-group-item"><b>Nature: </b>'+record.nature+'</li><li class="list-group-item"><b>Sub Nature: </b>'+record.sub_nature+'</li><li class="list-group-item"><b>Date_of_publication: </b>'+data_pubblicazione+'</li><li class="list-group-item"><b>License: </b>'+record.license+'</li>'+status_pub+'</ul></div><div class="modal-footer"><button  type="button" class="btn btn-default" data-dismiss="modal">Close</button></div></div></div></div></div>';
			var modal='<div class="modal fade" id="info-modal_proc'+record.id+'" role="dialog"><div class="modal-dialog"><div class="modal-content"><div class="modal-header" style="padding-bottom: 10px"><button type="button" class="close" data-dismiss="modal">&times;</button><h4 class="modal-title">Details of Resource: '+record.file_name+'</h4></div><div class="modal-body" style="padding:0px;""><center><div class="dashboardsListCardImgDiv" style="background-image:url('+record.image+'); overflow: auto; margin-top: 10px; margin-bottom: 5px;"></div></a><div class="row"><h4>Resource name: <span>'+record.file_name+'</span></h4><h4>Rating:</h4><div class="ratin"><input name="input"  class="rating-loading" step="0.1 "value="'+record.average_stars+'">( mean '+record.average_stars+' on '+record.votes+' votes)</div></center><ul class="list-group" style="margin-bottom: 0px;"><li class="list-group-item"><b>Description: </b>'+description+'</li><li class="list-group-item" id="itemUsername" hidden><b>Username: </b>'+record.username+'</li><li class="list-group-item"><b>Resource Type: </b>'+record.resource_type+'</li><li class="list-group-item"><b>Nature: </b>'+record.nature+'</li><li class="list-group-item"><b>Sub Nature: </b>'+record.sub_nature+'</li><li class="list-group-item"><b>Date_of_publication: </b>'+data_pubblicazione+'</li><li class="list-group-item"><b>License: </b>'+record.license+'</li>'+status_pub+'</ul></div><div class="modal-footer"><button  type="button" class="btn btn-default" data-dismiss="modal">Close</button></div></div></div></div></div>';
		...
		if(file_type=="Mobile App"){
			var modal='<div class="modal fade" id="info-modal_proc'+record.id+'" role="dialog"><div class="modal-dialog"><div class="modal-content"><div class="modal-header" style="padding-bottom: 10px"><button type="button" class="close" data-dismiss="modal">&times;</button><h4 class="modal-title">Details of Resource: '+record.file_name+'</h4></div><div class="modal-body" style="padding:0px;"><center><div class="dashboardsListCardImgDiv" style="background-image:url('+record.image+'); overflow: auto; margin-top: 10px; margin-bottom: 5px;"></div></a><div class="row"><h4>Resource name: <span>'+record.file_name+'</span></h4><h4>Rating:</h4><div class="ratin"><input name="input"  class="rating-loading" step="0.1 "value="'+record.average_stars+'">( mean '+record.average_stars+' on '+record.votes+' votes)</div></center><ul class="list-group" style="margin-bottom: 0px;"><li class="list-group-item"><b>Description: </b>'+description+'</li><li class="list-group-item" id="itemUsername" hidden><b>Username: </b>'+record.username+'</li><li class="list-group-item"><b>Resource Type: </b>'+record.resource_type+'</li><li class="list-group-item"><b>OS: </b>'+record.OS+'</li><li class="list-group-item"><b>Category: </b>'+record.nature+'</li><li class="list-group-item"><b>OpenSource: </b>'+record.OpenSource+'</li><li class="list-group-item"><b>Date_of_publication: </b>'+data_pubblicazione+'</li><li class="list-group-item"><b>License: </b>'+record.license+'</li>'+status_pub+'</ul><div class="space-ten"></div></div><div class="modal-footer"><button  type="button" class="btn btn-default" data-dismiss="modal">Close</button></div></div></div></div></div>';
			//var modal='<div class="modal fade" id="info-modal_proc'+record.id+'" role="dialog"><div class="modal-dialog"><div class="modal-content"><div class="modal-header"><button type="button" class="close" data-dismiss="modal">&times;</button><h4 class="modal-title">Details of Resource: '+record.file_name+'</h4></div><div class="modal-body"><center><img src="'+record.image+'" height="50%" width="50%" border="0" ></a><div class="row"><h4>Resource name: <span>'+record.file_name+'</span></h4><h4>Rating:</h4><div class="ratin"><input name="input"  class="rating-loading" step="0.1 "value="'+record.average_stars+'">( mean '+record.average_stars+' on '+record.votes+' votes)</div></center><ul class="list-group"><li class="list-group-item"><b>Description: </b>'+description+'</li><li class="list-group-item" id="itemUsername" hidden><b>Username: </b>'+record.username+'</li><li class="list-group-item"><b>Resource Type: </b>'+record.resource_type+'</li><li class="list-group-item"><b>OS: </b>'+record.OS+'</li><li class="list-group-item"><b>Category: </b>'+record.nature+'</li><li class="list-group-item"><b>OpenSource: </b>'+record.OpenSource+'</li><li class="list-group-item"><b>Date_of_publication: </b>'+data_pubblicazione+'</li><li class="list-group-item"><b>License: </b>'+record.license+'</li>'+status_pub+'</ul><div class="space-ten"></div></div><div class="modal-footer"><button  type="button" class="btn btn-default" data-dismiss="modal">Close</button></div></div></div></div></div>';
		...
		if(file_type=="AMMA" || file_type=="DevDash" || file_type=="ResDash" ){
			var modal='<div class="modal fade" id="info-modal_proc'+record.id+'" role="dialog"><div class="modal-dialog"><div class="modal-content"><div class="modal-header" style="padding-bottom: 10px"><button type="button" class="close" data-dismiss="modal">&times;</button><h4 class="modal-title">Details of Resource: '+record.file_name+'</h4></div><div class="modal-body" style="padding:0px;"><center><div class="dashboardsListCardImgDiv" style="background-image:url('+record.image+'); overflow: auto; margin-top: 10px; margin-bottom: 5px;"></div></a><div class="row"><h4>Resource name: <span>'+record.file_name+'</span></h4><h4>Rating:</h4><div class="ratin"><input name="input"  class="rating-loading" step="0.1 "value="'+record.average_stars+'">( mean '+record.average_stars+' on '+record.votes+' votes)</div></center><ul class="list-group" style="margin-bottom: 0px;"><li class="list-group-item"><b>Description: </b>'+description+'</li><li class="list-group-item" id="itemUsername" hidden><b>Username: </b>'+record.username+'</li><li class="list-group-item"><b>Resource Type: </b>'+record.resource_type+'</li><li class="list-group-item"><b>Nature: </b>'+record.nature+'</li><li class="list-group-item"><b>Sub Nature: </b>'+record.sub_nature+'</li><li class="list-group-item"><b>Date_of_publication: </b>'+data_pubblicazione+'</li><li class="list-group-item"><b>License: </b>'+record.license+'</li>'+status_pub+'</ul><div class="space-ten"></div></div><div class="modal-footer"><button  type="button" class="btn btn-default" data-dismiss="modal">Close</button></div></div></div></div></div>';
			//var modal='<div class="modal fade" id="info-modal_proc'+record.id+'" role="dialog"><div class="modal-dialog"><div class="modal-content"><div class="modal-header"><button type="button" class="close" data-dismiss="modal">&times;</button><h4 class="modal-title">Details of Resource: '+record.file_name+'</h4></div><div class="modal-body"><center><img src="'+record.image+'" height="50%" width="50%" border="0" ></a><div class="row"><h4>Resource name: <span>'+record.file_name+'</span></h4><h4>Rating:</h4><div class="ratin"><input name="input"  class="rating-loading" step="0.1 "value="'+record.average_stars+'">( mean '+record.average_stars+' on '+record.votes+' votes)</div></center><ul class="list-group"><li class="list-group-item"><b>Description: </b>'+description+'</li><li class="list-group-item" id="itemUsername" hidden><b>Username: </b>'+record.username+'</li><li class="list-group-item"><b>Resource Type: </b>'+record.resource_type+'</li><li class="list-group-item"><b>Nature: </b>'+record.nature+'</li><li class="list-group-item"><b>Sub Nature: </b>'+record.sub_nature+'</li><li class="list-group-item"><b>Date_of_publication: </b>'+data_pubblicazione+'</li><li class="list-group-item"><b>License: </b>'+record.license+'</li>'+status_pub+'</ul><div class="space-ten"></div></div><div class="modal-footer"><button  type="button" class="btn btn-default" data-dismiss="modal">Close</button></div></div></div></div></div>';
		...
		if(file_type=="Banana Library" ){
			var modal='<div class="modal fade" id="info-modal_proc'+record.id+'" role="dialog"><div class="modal-dialog"><div class="modal-content"><div class="modal-header" style="padding-bottom: 10px"><button type="button" class="close" data-dismiss="modal">&times;</button><h4 class="modal-title">Details of Resource: '+record.file_name+'</h4></div><div class="modal-body" style="padding:0px;"><center><div class="dashboardsListCardImgDiv" style="background-image:url('+record.image+'); overflow: auto; margin-top: 10px; margin-bottom: 5px;"></div></a><div class="row"><h4>Resource name: <span>'+record.file_name+'</span></h4><h4>Rating:</h4><div class="ratin"><input name="input"  class="rating-loading" step="0.1 "value="'+record.average_stars+'">( mean '+record.average_stars+' on '+record.votes+' votes)</div></center><ul class="list-group" style="margin-bottom: 0px;"><li class="list-group-item"><b>Description: </b>'+description+'</li><li class="list-group-item" id="itemUsername" hidden><b>Username: </b>'+record.username+'</li><li class="list-group-item"><b>Resource Type: </b>'+record.resource_type+'</li><li class="list-group-item"><b>Nature: </b>'+record.nature+'</li><li class="list-group-item"><b>Sub Nature: </b>'+record.sub_nature+'</li><li class="list-group-item"><b>Real-time: </b>'+record.realtime+'</li><li class="list-group-item"><b>Periodic: </b>'+record.periodic+'</li><li class="list-group-item"><b>Date_of_publication: </b>'+data_pubblicazione+'</li><li class="list-group-item"><b>License: </b>'+record.license+'</li>'+status_pub+'</ul><div class="space-ten"></div></div><div class="modal-footer"><button  type="button" class="btn btn-default" data-dismiss="modal">Close</button></div></div></div></div></div>';
			//var modal='<div class="modal fade" id="info-modal_proc'+record.id+'" role="dialog"><div class="modal-dialog"><div class="modal-content"><div class="modal-header"><button type="button" class="close" data-dismiss="modal">&times;</button><h4 class="modal-title">Details of Resource: '+record.file_name+'</h4></div><div class="modal-body"><center><img src="'+record.image+'" height="50%" width="50%" border="0" ></a><div class="row"><h4>Resource name: <span>'+record.file_name+'</span></h4><h4>Rating:</h4><div class="ratin"><input name="input"  class="rating-loading" step="0.1 "value="'+record.average_stars+'">( mean '+record.average_stars+' on '+record.votes+' votes)</div></center><ul class="list-group"><li class="list-group-item"><b>Description: </b>'+description+'</li><li class="list-group-item" id="itemUsername" hidden><b>Username: </b>'+record.username+'</li><li class="list-group-item"><b>Resource Type: </b>'+record.resource_type+'</li><li class="list-group-item"><b>Nature: </b>'+record.nature+'</li><li class="list-group-item"><b>Sub Nature: </b>'+record.sub_nature+'</li><li class="list-group-item"><b>Real-time: </b>'+record.realtime+'</li><li class="list-group-item"><b>Periodic: </b>'+record.periodic+'</li><li class="list-group-item"><b>Date_of_publication: </b>'+data_pubblicazione+'</li><li class="list-group-item"><b>License: </b>'+record.license+'</li>'+status_pub+'</ul><div class="space-ten"></div></div><div class="modal-footer"><button  type="button" class="btn btn-default" data-dismiss="modal">Close</button></div></div></div></div></div>';
		...
		//var modal_publish='<form class="change_publish" method="post" action="modify_status_resource.php'+sf+'"><div class="modal fade" id="publish-modal_proc'+record.id+'" role="dialog"><div class="modal-dialog"><div class="modal-content"><div class="modal-header"><button type="button" class="close" data-dismiss="modal">&times;</button><h4 class="modal-title">Change status of publication: '+record.file_name+'</h4></div><div class="modal-body">Are you sure do you want change status of publication?<input type="text" name="id" value="'+record.id+'" hidden></input><input type="text" name="status" value="'+record.Public+'" hidden><input type="text" name="lic" value="'+record.license+'" hidden></input><input type="text" name="form" value="'+record.format+'" hidden><input type="text" name="access" value="'+record.protocol+'" hidden></input></input></input></div><div class="modal-footer"><button  type="button" class="btn btn-default" data-dismiss="modal">Close</button><input type="submit" value="Submit" class="btn btn-secondary"></div></div></div></div></form>';
