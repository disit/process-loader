...
if (!isset($_GET['pageTitle'])){
	$default_title = "Data Analytic Micro Service Editor";
}else{
	$default_title = "";
}
...
<?php include('functionalities.php'); ?>
		...
		<div class="col-xs-12 col-md-10" id="mainCnt">
			...
			<button type="button" id="hide_button" value="Hide Table" class="btn btn-warning" data-toggle="modal" data-target="#Hide" onclick="hide_table()">Add Data Analitics</button>
			<!--
			...
			<div id="collapse_editor" style="display: none;">
			  ...
			  <!-- -->
			  <div class="container">
				<form enctype="multipart/form-data" action="dataAnalyticUploadZip.php" id="upload" method="POST" accept-charset="UTF-8">
				<div class="panel panel-default">		
						<div class="panel-heading"><h3>Add Data Analytic MS</h3></div>
					<div class="panel-body">
								
								<div class="col-md-6">
											   <div class="card">
												  <div class="card-body"> 												 
														<input id="filetype" name="filetype" value="DataAnalyticMicroService" style="display: none;"></input>
														<input id="editor_page" name="editor" value="DataAnalyticMicroService" style="display: none;"></input>
														<div>
														...
														<br />
														<div class="input-group" id ="micro_name" ><span class="input-group-addon">Data Analytic MS Title: </span><input name="micro_name" type="text" class="form-control" id="title_micro0"></input>
														</div>
														<br />
														<div class="input-group" id ="micro_scriptR" ><span class="input-group-addon">Script R: </span><input name="micro_scriptR" type="file" class="form-control" id="title_microS"></input>
														</div>
														<br />
														<div class="input-group" id ="micro_url" ><span class="input-group-addon">Relative Url: </span><input name="url" type="text" class="form-control" id="url_input0" required="required"></input>
														</div>
														<br />
			...
			<div class="edit_microserv" style="display: none;">
				<form name="param_login_1" method="post" action="modify_dataAnalyticMicroService.php" id="modal_modify" enctype="multipart/form-data" > 
			  <div class="container">
						...
						<div class="panel-body">
							<div class="tab-content">
								<div id="process_mandatory_parameter" class="tab-pane fade in active">
									...
									<input id="editor_page3" name="editor" value="DataAnalyticMicroService" style="display: none;"></input>	
									<div class="input-group"><span class="input-group-addon">Nature: </span>
									...
									<br />
									<div class="input-group" id ="micro_check3" style="display:none;">
										Do you want create a Microservice with Authentication?    <input type="checkbox" id="auth_check3" name="auth_check3" value="Yes"/>
									</div>
									<div class="input-group" id ="micro_scriptR3" ><span class="input-group-addon">Script R: </span><input name="micro_scriptR3" type="file" class="form-control" id="title_microS3"></input>
									</div>
									<br />
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div id="param_del" hidden>
				...
				<input id="editor_page_del" name="editor" value="DataAnalyticMicroService" style="display: none;"></input>	
			</div>
			<div class="panel-footer">
...
<div class="modal-body" style="background-color: white">
<form enctype="multipart/form-data" action="dataAnalyticUploadZip.php" id="uploadRes" method="POST" accept-charset="UTF-8">
	<input id="filetype1" name="filetype" value="DataAnalyticMicroService" style="display: none;"></input>	
	<input id="editor_page1" name="editor" value="DataAnalyticMicroService" style="display: none;"></input>		
	<div>
	<div class="input-group"><span class="input-group-addon">Description : </span><input name="filedesc" type="text" class="form-control" required="required" /></div>
	</div>
	<br />	
	...
	<br/>
	<div class="input-group" id ="micro_name1" ><span class="input-group-addon">DataAnalyticMicroService Title: </span><input name="micro_name" type="text" class="form-control" id="title_micro"></input>
	</div>
	<br />
...
<!-- Modal Pulish2 -->
  <div class="modal fade bd-example-modal-lg" id="publish" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
		<div class="modal-dialog">
				...
				<div>
				<input id="editor_page_pub" name="editor" value="DataAnalyticMicroService" style="display: none;"></input>	
 ...
 <!-- -->
	...
	function hide_table() {
		if ($('#collapse_table').is(":visible")){
			...
			$("#hide_button").attr('value', 'Data Analitics');
			$("#hide_button").text('Data Analitics'); 	
	...
	$(document).ready(function () {
		...
		if (nascondi == 'hide'){
			...
			$('#modal_modify').attr("action","modify_dataAnalyticMicroService.php?showFrame=false");
			...
			$('#upload').attr("action","dataAnalyticUploadZip.php?showFrame=false");
		}
		...
		$.ajax({
			url: "getdata.php",
				data: {action: "get_microservices_microAnalitys"},
				type: "GET",
				async: true,
				dataType: 'json',
