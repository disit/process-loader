...
Please, verify value types, value units, and data types carefully!
            ...
            if ($xlsx = SimpleXLSX::parse($target_dir . $file_name)) {
                ...
                echo "<tr><td colspan=\"2\" style=\"background-color: white;border-top-style: hidden;border-left-style: hidden;border-bottom-style: hidden;\"></td><td style=\"width: 100px;background: cadetblue;font-family: Montserrat;font-weight:400; font-size: 14px;\">" . implode("</td><td style=\"width: 100px;background: cadetblue;font-family: Montserrat;font-weight:400; font-size: 14px;\">", $dateObserved_type == 'file' ? $value_type_comboboxes_dof_array : $value_type_comboboxes_array) . "</td></tr>";
                ...
                $header_row = "";
                if ($dateObserved_type == 'file') {
                    $header_row .= '<tr class=header><td style="background: #1C70D2;width: 100px;font-weight: bold">Sheet Name</td><td style="background: #1C70D2;width: 100px;font-weight: bold">Device Name</td><th style="color: black;">' . implode('</th><th style="color: black;">', $all_headers_dof_array) . '</th><td class=\"header\" style="color: black;font-family: Montserrat;font-weight:400; font-size: 14px;width: 120px;background: #1C70D2;"> dateObserved</td></tr>';
                } else {
                    $header_row .= '<tr class=header><td style="background: #1C70D2;width: 100px;font-weight: bold">Sheet Name</td><td style="background: #1C70D2;width: 100px;font-weight: bold">Device Name</td>';
                ...
                if ($coordinate_type == 'file' ||$coordinate_type == 'address') {
                    $header_row = substr($header_row, 0, count($header_row) - 6);
                    $header_row .= '<td style="background: #1C70D2;width:100px;color: black;font-family: Montserrat;font-weight:400; font-size: 14px;">' . 'Latitude' . '</td><td style="background: #1C70D2;width:100px;color: black;font-family: Montserrat;font-weight:400; font-size: 14px;">' . 'Longitude' . '</td>';
                }

                $header_row = substr($header_row, 0, count($header_row) - 6);
                $header_row .= '<td style="background: #1C70D2;width:100px;color: black;font-family: Montserrat;font-weight:400; font-size: 14px;">' . 'Nature' . '</td>';
                $header_row .= '<td style="background: #1C70D2;width:100px;color: black;font-family: Montserrat;font-weight:400; font-size: 14px;">' . 'Sub-Nature' . '</td>';
                
                $header_row .= '<td style="background: #1C70D2;width:100px;color: black;font-family: Montserrat;font-weight:400; font-size: 14px;width: 155px;">' . 'Context Broker' . '</td></tr>';
