...
function update_down()
{
	...
	url_get($url);  
	header("location:view_public_processes_for_all.php");
	die;
}
...
<body >
	...
	<div class="container-fluid text-center">    
	  <div class="row content">
		...
		<p><a href="view_public_processes_for_all.php">View public processes</a></p>
		</div>
	...
	<div class="col-sm-8 text-left">
		...
		<form enctype="multipart/form-data" action="view_public_processes_for_all.php" id="search_input_form" method="POST" accept-charset="UTF-8">
